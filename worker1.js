...
### 9. Key Context for AI Assistants

- Love prefers **concise, audience-tailored communications** with strong emotional resonance
- Comfortable with deep technical detail AND executive-level strategy — bridge between both worlds
- Strong preference for **React** (frontend) and **Python** (backend) in technology projects
- Active retail investor; familiar with trading regulations (wash sale, PDT, settlement, capital gains)
- Nonprofit communications style: strong emotional hook, GenAI as differentiator, impact-first framing
- Personal values poster series mantra: **Work Hard · Be Nice · Have Fun**
- Website built on Next.js, hosted on Vercel
